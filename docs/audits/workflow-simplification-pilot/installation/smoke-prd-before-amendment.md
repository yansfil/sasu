...
review_rationale: "A real installed CLI completion and receipt-consumer smoke needs one bounded semantic review."
...
Provide a tiny local link-normalization library whose behavior can be executed, tested, reviewed, finalized, and consumed through the globally installed workflow.
