...
test("parseVerification prefers matrix rows over bullets and normalizes matrix fields", () => {
  const section = [
    ...
    "| --- | --- | --- | --- | --- | --- |",
    "| V1 | build/static | R1, AC1 | tests pass | yes | no |",
    "| V2 | browser/runtime | R2 | page renders | no | yes |",
    "",
  ...
  assert.match(items[0].text, /Pass: tests pass/);
...
test("coverage ranges expand identically for tasks and verification rows", () => {
  const tasks = parser.parseMarkdownItems("- T1. implement the rules. Covers R1-R3, AC2-AC5.", "T", "Task");
