...
description: |
  ...
  Use when the user invokes "$ho-interview", asks to interview an idea,
  ...
  The "$ho-scope" compatibility alias follows this same workflow.
...
Use this skill before ho-spec when an idea needs a decision-quality interview.
...
~~~sh
node ~/.codex/skills/ho-interview/scripts/validate_intake.mjs \
