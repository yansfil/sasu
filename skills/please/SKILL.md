...
- If delivery mode is `local`, run the post-receipt local delivery command to commit remaining allowlisted changes or validate existing unpushed implementation history and record its delivery result.
